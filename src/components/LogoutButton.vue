...
<template>
  <button
    @click="logout"
    class="group flex items-center justify-start w-11 h-11 bg-blue-700 rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1"
  >
    <div
